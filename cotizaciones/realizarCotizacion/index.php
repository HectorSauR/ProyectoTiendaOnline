          ...
          ?>
              ...
              <tr>
                ...
                <form class="producto" action="./php/modificarCotizacion.php" method="POST">
                  ...
                  <td>
                    <p class="hidden"><?php echo $row['CANTIDAD'] ?></p> <input type="number" name="cantidad" value="<?php echo $row['CANTIDAD'] ?>" class="cantidad"><button class="borrar" type="submit"><i class="fa-solid fa-pen icon_change"></button></i>
                  </td>
                </form>
